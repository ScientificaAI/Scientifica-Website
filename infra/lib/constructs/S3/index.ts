...
export class S3 extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    const DOMAIN_NAME = "scientifica.ai";
    ...
    this.web_bucket_deployment = new BucketDeployment(
      ...
      {
        sources: [
          Source.asset(resolve(__dirname, "..", "..", "..", "..", "dist")),
        ],
    ...
    const certificateArn =
      "arn:aws:acm:us-east-1:058264561390:certificate/f3ceee45-5a07-4c2e-a575-2a46f1f8c190";
